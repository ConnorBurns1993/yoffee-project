...
const AddBusinessForm = () => {
  ...
  return (
    ...
    <div className='tos'>By creating your business, you agree to Yoffee's <NavLink to='/businesses/hey/create' className='links'>Terms of Service</NavLink> and <NavLink to='/businesses/hey/create' className='links'>Privacy Policy.</NavLink></div>
        ...
        <button className='login3' type="submit">Submit</button>
        <button className='login3' type="button" onClick={handleCancelClick}>
          Cancel
        </button>
      </form>
      <img className='coffee-art-create-business' src='https://st2.depositphotos.com/1033554/12390/i/950/depositphotos_123909404-stock-photo-3d-rendering-of-a-coffee.jpg' alt=''></img>
