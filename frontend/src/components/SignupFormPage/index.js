...
function SignupFormPage() {
  ...
  return (
    <>
    <div className='mock-header'><NavLink exact to='/'><img src='https://i.imgur.com/WNhN3BB.png' className='mock-header-img' alt=''></img></NavLink></div>
    <form onSubmit={handleSubmit}>
     ...
     <NavLink exact to='/'><button className='demo-user facebook'>
      ...
      <div className='dont-worry'>Don't worry, we never post without your permission.</div>
      ...
      <div className='new-to-yoffee2'>Already on Yoffee?<NavLink to='/login' className='links new'>Log In</NavLink></div>
      </div>
    </form>
    ...
    <div className='footer-2'>
        ...
        <a href='https://www.linkedin.com/in/connor-burns-647766194/' target='_blank' rel="noreferrer" className='footer-content linkedin links' alt=''>LinkedIn</a>
    </div>
</div>
</>
  );
